...
import { showRegPhoneModal, showRegPhotoModal, hideRegPhotoModal } from '../../../redux/Users/Users.actions';
import AccountCircleOutlinedIcon from '@material-ui/icons/AccountCircleOutlined';


const PhotoModal = () => {
    const dispatch = useDispatch();
    const showPhotoModal = useSelector((state) => state.views.regPhotoModal);
    const handleBack = () => {
    ...
    return (
        <Dialog aria-labelledby="photoModal" open={showPhotoModal} TransitionComponent={Transition}>
            <DialogTitle id="photoModal" onBack={handleBack}>
                建立個人資料
            </DialogTitle>
            <DialogContent dividers>
                <Typography align="center" >步驟2之2</Typography>
                <Typography align="center" variant='h6'>新增個人資料照片</Typography>
